...
public class MostlikelySettings extends Fragment {
    Button button;
    EditText editText;
    final String file = "MostLikely.txt";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = inflater.inflate(R.layout.fragment_most_likely_settings, container, false);
        button = (Button) v.findViewById(R.id.MostLikelySettingsButton);
