 ...
 */
public class TruthSettings extends Fragment {
    Button button;
    EditText editText;
    final String file = "Truth.txt";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = inflater.inflate(R.layout.fragment_truth_settings, container, false);
        button = (Button) v.findViewById(R.id.TruthSettingsButton);
        editText = (EditText) v.findViewById(R.id.TruthSettingsEdit);
