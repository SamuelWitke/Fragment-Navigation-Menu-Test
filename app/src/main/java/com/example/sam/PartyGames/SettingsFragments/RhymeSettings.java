...
/**
 * Created by sam on 1/11/17.
 */

public class RhymeSettings extends Fragment{
    Button button;
    EditText editText;
    final String file = "Rhyme.txt";

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        // Inflate the layout for this fragment
        View v = inflater.inflate(R.layout.fragment_rhyme_settings, container, false);
        button = (Button) v.findViewById(R.id.RhymeSettingsButton);
        editText = (EditText) v.findViewById(R.id.RhymeSettingsEdit);
