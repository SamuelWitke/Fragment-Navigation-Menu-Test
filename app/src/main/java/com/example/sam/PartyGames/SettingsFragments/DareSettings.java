 ...
 */
public class DareSettings extends Fragment {
    Button button;
    EditText editText;
    final String file = "Dare.txt";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_dare_settings, container, false);
        button = (Button) v.findViewById(R.id.DareSettingsButton);
        editText = (EditText) v.findViewById(R.id.DareSettingsEdit);
