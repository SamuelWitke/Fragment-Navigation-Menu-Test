 ...
 */
public class Rhyme extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        name = (TextView) v.findViewById(R.id.RhymeName);
        view = (TextView)v.findViewById(R.id.RhymeView);

        name.setText(KingsGame.getName());

        button = (Button)v.findViewById(R.id.RhymeButton);
        ...
        fileImport.readFile("Rhyme.txt",list);
